...
- `inputs` — _obligatory_ `Array` of [CardanoInput](https://github.com/OneKeyHQ/connect/blob/onekey/src/js/types/networks/cardano.js#L59)
- `outputs` - _obligatory_ `Array` of [CardanoOutput](https://github.com/OneKeyHQ/connect/blob/onekey/src/js/types/networks/cardano.js#L74)
- `fee` - _obligatory_ `String`
- `protocolMagic` - _obligatory_ `Integer` 764824073 for Mainnet, 42 for Testnet
- `networkId` - _obligatory_ `Integer` 1 for Mainnet, 0 for Testnet
