...
- `publicKey` - _obligatory_ `string` signer public key.
- `signature` - _obligatory_ `string` message signature
- `message` - _obligatory_ `string` signed message in plain text
