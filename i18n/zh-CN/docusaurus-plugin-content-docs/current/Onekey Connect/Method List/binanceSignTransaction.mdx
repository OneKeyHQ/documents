...
## Binance：签署交易
要求设备使用给定的[BIP44路径](./path)派生的私钥对给定的交易进行签名。要求用户在OneKey上确认所有交易
的详细信息。
...
* `transaction` - *必需* 对象类型的[transaction](https://github.com/OneKeyHQ/connect/blob/onekey/src/js/types/binance.js#L61-71)是必填项
