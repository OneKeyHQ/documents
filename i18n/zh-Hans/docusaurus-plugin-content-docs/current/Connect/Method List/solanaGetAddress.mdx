...
返回一组 solana 地址且不在设备上显示它们

```javascript
OneKeyConnect.solanaGetAddress({
    bundle: [
        { path: "m/44'/501'/0'/0'", showOnDevice: false }, // 账户 1
        { path: "m/44'/501'/1'/0'", showOnDevice: false }, // 账户 2
        { path: "m/44'/501'/2'/0'", showOnDevice: false }  // 账户 3
    ]
});
```
